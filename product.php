...
if(isset($_POST['form_add_to_cart'])) {
    ...
    if(isset($_SESSION['cart_p_id'])){
        ...
        $custom_mod = array('comment' => $comment, 'link'=> null, 'custom' => null, 'shipping' => null);
        ...
        if($added == 1) {
           $error_message1 = 'This product is already added to the shopping cart.';
            ...
            $_SESSION['cart_p_type'][$new_key] = 0;
						...
						<div class="col-md-7">
                            ...
                            <form action="" method="post">
                					...
                					<div class="p-price">
                                            ...
                                            <span>
                                                <?php if($p_old_price!=''): ?>
                                                    <del><?php echo $site_currency." ".$p_old_price; ?></del>
                                                <?php endif; ?> 
                                                    <?php echo $site_currency." ".$p_current_price; ?>
                                            </span>
                                    </div>
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                ...
                                <h4>
                                    <?php echo $site_currency." ".$row['p_current_price']; ?> 
                                    <?php if($row['p_old_price'] != ''): ?>
                                    <del>
                                        <?php echo $site_currency." ".$row['p_old_price']; ?>
                                    </del>
                                    <?php endif; ?>
                                </h4>
                                <div class="rating">
