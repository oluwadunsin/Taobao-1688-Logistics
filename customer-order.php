            ...
            ?>
                                ...
                                foreach ($result as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            $statement1 = $pdo->prepare("SELECT * FROM tbl_order WHERE payment_id=?");
                                                ...
                                                foreach ($result1 as $row1) {
                                                    ...
                                                    echo '<br>Product Link: '.$row1['product_link'];
                                                    echo '<br>Size: '.$row1['size'];
                                                    echo '<br>Color: '.$row1['color'];
                                                    echo '<br>Custom: '.$row1['custom'];
                                                    echo '<br>Quantity: '.$row1['quantity'];
                                                    echo '<br>Unit Price: '.$row1['unit_price'];
                                                    echo '<br>Info: '.$row1['product_comment'];
                                                    echo '<br><br>';
                                                    $tracking_code .= $row1['product_site_track'].'<br>';
                                                }
                                            ?>
                                        </td>
                                        ...
                                        <td><?php if($row['payment_status'] == 'Completed'){echo '<a href="invoice.php?id='.$row['payment_id'].'" target="_blank">view invoice</a>';} ?></td>
